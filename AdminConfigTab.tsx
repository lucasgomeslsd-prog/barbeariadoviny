...
import { saveStoredConfig, changeAdminPassword } from '../../../utils/storage';
...
export function AdminConfigTab({ config, onRefresh }: AdminConfigTabProps) {
  ...
  const [logo, setLogo] = useState(config.logo || '/logo_viny.jpg');
  ...
  useEffect(() => {
    ...
    setLogo(config.logo || '/logo_viny.jpg');
  ...
  const handleSaveAll = (e: FormEvent) => {
    ...
    const updatedConfig: BarbershopConfig = {
      ...
      clientTopTitle: clientTopTitle.trim() || name.trim(),
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
          ...
          <div className="sm:col-span-2">
            ...
            <input
              ...
              placeholder="/logo_viny.jpg ou link da imagem"
