  ...
  const handleSavePro = (e: FormEvent) => {
    ...
    if (editingPro) {
      ...
      const updatedPro: BarberProfessional = {
        ...
        phone: proFormPhone.trim() || undefined,
        specialty: proFormSpecialty.trim() || undefined,
        ...
        weeklySchedule: proFormHasCustomSchedule
          ? editingPro.weeklySchedule || DEFAULT_WEEKLY_SCHEDULE.map((d) => ({ ...d }))
          : undefined,
      };
