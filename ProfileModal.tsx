...
import { formatPhoneMask, saveStoredClient, clearStoredClient, getStoredConfig } from '../utils/storage';
        ...
        <div className="flex items-center justify-between pb-4 border-b border-stone-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-stone-400 uppercase tracking-wider">{config.name}</p>
            </div>
          </div>
          <button
