...
export const DEFAULT_BARBERSHOP_CONFIG: BarbershopConfig = {
  ...
  state: 'SP',
  zipCode: '01001-000',
  instagram: '@barbeariadoviny',
  logo: '/logo_viny.jpg',
  clientTopTitle: 'BARBEARIA DO VINY',
  ...
  msgBookingConfirmed: 'Seu agendamento foi confirmado pela Barbearia do Viny!',
  ...
  pixKey: '11987654321',
  pixKeyType: 'Celular',
  pixReceiverName: 'Barbearia do Viny',
  pixCity: 'São Paulo',
  blockedSlots: [],
  slotInterval: 30,
